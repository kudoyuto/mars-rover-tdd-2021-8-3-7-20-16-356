...
class MarsRoverTest {
    ...
    @Test
    void should_return_location_x_1_location_y_0_direction_E_when_execute_command_given_location_x_0_location_y_0_and_M(){
        //given
    ...
    @Test
    void should_return_location_x_0_location_y_0_direction_N_when_execute_command_given_location_x_0_location_y_0_and_L(){
        //given
        MarsRover marsRover = new MarsRover(new RoverStatus(0,0,"E"));
    ...
    @Test
    void should_return_location_x_0_location_y_0_direction_S_when_execute_command_given_location_x_0_location_y_0_and_R(){
        //given
        MarsRover marsRover = new MarsRover(new RoverStatus(0,0,"E"));
    ...
    @Test
    void should_return_location_x_negative_1_location_y_0_direction_W_when_execute_command_given_location_x_0_location_y_0_and_M(){
        //given
    ...
    @Test
    void should_return_location_x_0_location_y_0_direction_S_when_execute_command_given_location_x_0_location_y_0_and_L(){
        //given
        MarsRover marsRover = new MarsRover(new RoverStatus(0,0,"W"));
        RoverStatus expectedRoverStatus = new RoverStatus(0,0,"S");
        //when
    ...
    @Test
    void should_return_location_x_0_location_y_0_direction_N_when_execute_command_given_location_x_0_location_y_0_and_R(){
        //given
        MarsRover marsRover = new MarsRover(new RoverStatus(0,0,"W"));
        RoverStatus expectedRoverStatus = new RoverStatus(0,0,"N");
        //when
